...
{showVerdict && analysisResult && (
  <section className="fixed inset-0 z-50 flex items-start sm:items-center justify-center p-0 sm:p-4 md:p-6 bg-black/80 backdrop-blur-sm animate-fadeIn">
    {/* Added 'relative' and 'overflow-hidden' to lock the outer box */}
    <div className="glass-verdict coin-slide w-full sm:max-w-4xl sm:rounded-3xl shadow-2xl my-0 sm:my-auto max-h-screen sm:max-h-[95vh] flex flex-col relative overflow-hidden">
      ...
      <div className="overflow-y-auto custom-scrollbar flex-1 overscroll-contain h-full">
        ...
        <div className="p-4 md:p-6 lg:p-8 border-b border-white/10 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 relative overflow-hidden">
          ...
          {/* Close button inside the header so it's always accessible */}
          <button 
